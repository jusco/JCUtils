...
// JCUtils
#define COCOAPODS_POD_AVAILABLE_JCUtils
#define COCOAPODS_VERSION_MAJOR_JCUtils 0
#define COCOAPODS_VERSION_MINOR_JCUtils 1
#define COCOAPODS_VERSION_PATCH_JCUtils 0
